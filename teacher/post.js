...
class Feed extends React.Component {
  ...
  render() {
    ...
    const posts = k.map((post,idx) => <AllPosts navigate={navigate} del={this.delete} user={this.props.userd} key={post._id} liked={post.liked} post={post} />
  ...
  //   return state;
    ...
    const empty = (
      <View style={styles.empty}>
        ...
        <TouchableOpacity
          onPress={() => this.props.navigation.navigate("NewPost",{feed:true,Post:null,group:null,from: navigate.state.routeName,userId:user_id})}
        >
