...
import { add } from "../../actions/updateQuiz";
...
class Quiz extends React.Component {
  ...
  submit() {
    ...
    class_id =  this.props.navigation.getParam("id")
    ...
    // const created = d.getFullYear() + "-" + d.getMonth() + "-" + d.getDay();
     let {attachments,DueDate,Guide,Title,created,classId} = this.state
      ...
      this.props.send(upload,feedback)
      if (feedback) {
        push.sendPushNotification('New Assignment','Due  '+ this.state.DueDate)
                this.setState({
                  attachments: [],
                  DueDate: "",
                  Time: "",
      ...
      ShowAlert('Quiz','unable to add Quiz')
    }
...
export default connect(mapPropToState, mapActionToState)(Quiz);
